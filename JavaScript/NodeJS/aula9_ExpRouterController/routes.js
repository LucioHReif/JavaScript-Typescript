...
const homeController = require('./controllers/homeController'); //importa o codigo do arquivo
const contatoController = require('./controllers/contatoController'); //importa o codigo do arquivo
